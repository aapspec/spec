...
## Standard Constraint Types and Semantics
...
## Malicious or Excessive Delegation
...
## Use Outside Intended Environment
...
## Backwards Compatibility with OAuth 2.0
...
## Migration Path from Scopes to Capabilities
...
## Fine-Grained Authorization Systems (Zanzibar, ReBAC)
...
## Step 1: Agent Obtains Original Token
...
## Step 2: Agent Exchanges Token for Tool-Specific Token
...
3. Check if delegation allowed: `depth < max_depth` (0 < 2) PASS
...
## Error Handling Guidance for Clients
...
## Authorization Server Conformance Checklist
...
## Resource Server Conformance Checklist
...
## Example Token Validation Code (Pseudocode)
...
## Valid Token -- Basic Research Agent
...
## Edge Case -- Clock Skew Tolerance
